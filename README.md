...
1. Whether the final answer is extracted from the argument with answer extraction prompt A or B, these can be seen in main.py as "CONCLUDE_PROMPT_A" and "CONCLUDE_PROMPT_B".
